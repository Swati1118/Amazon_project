    ...
    <Container>
        ...
        <Main>
         ...
         <InputContainer>
                ...
                <InputContainer>
                    <p>Flat, House No,Building, Comapany, Apartment  </p>
                    <input type="text" placeholder="" onChange={(e) => setFlat(e.target.value)}
                value={flat}/>
                </InputContainer>

                <InputContainer>
                    <p>Area, Colony, Street</p>
                    <input type="text" placeholder="" onChange={(e) => setArea(e.target.value)}
                value={area}/> 
                </InputContainer>

                <InputContainer>
                    <p>Landmark </p>
                    <input type="text" placeholder="" onChange={(e) => setLandmark(e.target.value)}
                value={landmark}/> 
                </InputContainer>
